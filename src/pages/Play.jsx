		...
		<div className='w-screen h-screen bg-black bg-opacity-50'>
			<div className='w-[80vw] h-[90vh] bg-white overflow-scroll absolute top-[5vh] left-[10vw] p-10 shadow shadow-gray-300 rounded-lg'>
				<div className='w-full flex justify-end items-center'>
					<AiOutlineFullscreenExit className='text-2xl text-gray-500'/>
				</div>
				...
				<div className='w-full h-16 mt-8 relative'>
					<div className='w-full h-5 bg-gray-200 rounded-xl absolute'></div>
					<div className='w-[20%] h-5 bg-orange-400 rounded-xl absolute'></div>
					<div className='w-full flex justify-between absolute top-8'>
						<p>6:00/12:12</p>
						<div>
